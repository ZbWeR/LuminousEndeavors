<template>
  <div class="flex flex-col w-screen min-h-screen overflow-hidden bg-zinc-100">
    ...
    <div
      class="flex flex-col items-center flex-1 w-full mt-4 overflow-hidden lg:mx-auto"
    >
      <!-- 用户信息 -->
      <div
      ...
      <div
        ...
        class="p-4 mt-4 bg-white rounded-md shadow-md wid"
      >
        <!-- 报名信息 -->
      ...
      <div
        v-else
        class="flex flex-col px-3 py-4 mt-4 bg-white rounded-md shadow-md wid"
      >
        <form>
          <h1 class="text-2xl font-bold tracking-widest text-sky-400">
            报名信息
